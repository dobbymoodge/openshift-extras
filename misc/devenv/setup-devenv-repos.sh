...
#baseurl=https://mirror1.ops.rhcloud.com/enterprise/${1-enterprise-2.1}/rhel
#        https://mirror2.ops.rhcloud.com/enterprise/${1-enterprise-2.1}/rhel
#failovermethod=priority
#enabled=1
#gpgcheck=0
#gpgkey=https://mirror1.ops.rhcloud.com/libra/RPM-GPG-KEY-redhat-beta
...
#baseurl=https://mirror1.ops.rhcloud.com/enterprise/${1-enterprise-2.1}/jb-eap-6-for-rhel-6-server-rpms
#        https://mirror2.ops.rhcloud.com/enterprise/${1-enterprise-2.1}/jb-eap-6-for-rhel-6-server-rpms
#failovermethod=priority
#enabled=1
#gpgcheck=0
#gpgkey=https://mirror1.ops.rhcloud.com/libra/RPM-GPG-KEY-redhat-beta
...
#baseurl=https://mirror1.ops.rhcloud.com/enterprise/${1-enterprise-2.1}/jb-ews-2-for-rhel-6-server-rpms
#        https://mirror2.ops.rhcloud.com/enterprise/${1-enterprise-2.1}/jb-ews-2-for-rhel-6-server-rpms
#failovermethod=priority
#enabled=1
#gpgcheck=0
#gpgkey=https://mirror1.ops.rhcloud.com/libra/RPM-GPG-KEY-redhat-beta
...
baseurl=https://mirror.openshift.com/enterprise/${1-enterprise-2.1}/openshift_repositories_devenv/Test_Dependencies/\$basearch/os/
failovermethod=priority
enabled=1
priority=40
gpgcheck=0
...
name=Client repo for Enterprise Linux 6 - \$basearch
baseurl=https://mirror.openshift.com/enterprise/${1-enterprise-2.1}/openshift_repositories_devenv/Test_Dependencies_Libra/\$basearch/os/
failovermethod=priority
enabled=1
priority=40
gpgcheck=0
...
[Client-ruby193]
name=Client repo for Enterprise Linux 6 - \$basearch
baseurl=https://mirror.openshift.com/enterprise/${1-enterprise-2.1}/openshift_repositories_devenv/Client-ruby193/\$basearch/os/
failovermethod=priority
enabled=1
gpgcheck=0
gpgkey=https://mirror1.ops.rhcloud.com/libra/RPM-GPG-KEY-redhat-beta
...
[Client]
name=Client repo for Enterprise Linux 6 - \$basearch
baseurl=https://mirror.openshift.com/enterprise/${1-enterprise-2.1}/openshift_repositories/RHOSE-CLIENT-2.1/\$basearch/os
failovermethod=priority
enabled=1
gpgcheck=0
gpgkey=https://mirror1.ops.rhcloud.com/libra/RPM-GPG-KEY-redhat-beta
...
baseurl=https://mirror.openshift.com/enterprise/${1-enterprise-2.1}/openshift_repositories/RHOSE-INFRA-2.1/\$basearch/os/
failovermethod=priority
enabled=1
gpgcheck=0
gpgkey=https://mirror1.ops.rhcloud.com/libra/RPM-GPG-KEY-redhat-beta
...
baseurl=https://mirror.openshift.com/enterprise/${1-enterprise-2.1}/openshift_repositories/RHOSE-JBOSSEAP-2.1/\$basearch/os/
failovermethod=priority
enabled=1
gpgcheck=0
gpgkey=https://mirror1.ops.rhcloud.com/libra/RPM-GPG-KEY-redhat-beta
...
baseurl=https://mirror.openshift.com/enterprise/${1-enterprise-2.1}/openshift_repositories/RHOSE-NODE-2.1/\$basearch/os/
failovermethod=priority
enabled=1
gpgcheck=0
gpgkey=https://mirror1.ops.rhcloud.com/libra/RPM-GPG-KEY-redhat-beta
